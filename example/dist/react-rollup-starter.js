...
(function (factory) {
	...
	*/
	...
	function (_React$Component) {
	  inherits(ReactDemo, _React$Component);

	  function ReactDemo(props) {
	    classCallCheck(this, ReactDemo);

	    return possibleConstructorReturn(this, getPrototypeOf(ReactDemo).call(this, props));
	  }

	  createClass(ReactDemo, [{
	    key: "render",
	...
	var App = function App() {
	  return react.createElement(ReactDemo, null);
	};

	reactDom_1(react.createElement(App, null), document.getElementById('root'));

})));
//# sourceMappingURL=react-rollup-starter.js.map
